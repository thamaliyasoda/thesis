			...
			if(mysqli_num_rows($stdResult ) > 0)
			{
				while($students = mysqli_fetch_array($stdResult ))
				{
					$tablebody .='                    <tr>
									...
									<td>
										<a href="view_student.php?std='.$students['student_id'].'" class="view" target="_blank" ><i class="fas fa-eye" data-toggle="tooltip" title="View"></i></a>
									</td>
								</tr>';
				}
			}		
                 ...
                 <ul class="list-unstyled components">
                    ...
                    <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="reportSubmenu">
                            <li class="active"><a href="report_students_per_sport.php"><i class="fas fa-users"></i>Students Per Sports</a></li>
							...
							<div class="row">
								<div class="col-sm-8">
									<div class="form-group">
										<select name="sport_id" id="sport_id"  class="form-control selectpicker"  data-live-search="true"  >
											<option  value='0' ".$selectedsp.">Select a sports</option>
										<?php	
										 $spResult  = $conn->query("SELECT * FROM sports WHERE sports_status=1");
												while($allsports = mysqli_fetch_array($spResult )) {
													$selectedsp=($session["sport_id"] == $allsports[0])? "selected" : "";
													echo '<option   value="'.$allsports[0].'" '.$selectedsp.'>'.$allsports[1].' - '.$allsports[3].'</option>';
													}
													?>
											</select>
									</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										<input type="submit" name="get_student" class="btn btn-primary" value="Get allocated students">
									</div>
								</div>									
							</div>
						</div>
