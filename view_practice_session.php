...
WHERE
practice_id = $session ");
		$sport_sessions = mysqli_fetch_assoc($userresults);
		$spid = $sport_sessions['sport_id'];
...
<title>Sports Desk - KDMV | <?=$sport_sessions['practice_title']; ?></title>
				...
				<div class="card-rows">
					<div class="card border-success">
						<div class="card-body ">
							<div class="row">
								<div class="col-md-2">					
									<img src="images/sports/<?=$sport_sessions["sport_picture"]; ?>" width="100px" height="100px" />	
																
								</div>

								<div class="col-md-6">	
<?php if($sport_sessions["practice_status"] == -1)
{
										echo "<div class='form-group'>
										<h2><label style='color:red;font-size:30px' id='success_msg' ><b>CANCELLED!</b></label></h2>
									</div>";
}
	?>								
									<div class="form-group">
										<h3>Session: <b><?=$sport_sessions["practice_title"]; ?></b></h3>
									</div>
									<div class="form-group">
										<h5>Sport: <b><?=$sport_sessions["sport_name"]; ?></b></h5>
									</div>
									<div class="form-group">
										<label style='font-size:20px' >Session Description: <b><?=$sport_sessions["practice_description"]; ?></b></label>
									</div>
									<div class="form-group">
										<label style='font-size:20px' >Location: <b><?=$sport_sessions["practice_location"]; ?></b></label>
									</div>
									<div class="form-group">
										<label style='font-size:20px' >Date: <b><?=$sport_sessions["practice_date"]; ?></b></label>
									</div>	
									<div class="form-group">
										<label style='font-size:20px' >From: <b><?=$sport_sessions["practice_start_time"]; ?></b> To: <b><?=$sport_sessions["practice_end_time"]; ?></b></label>
									</div>										
								</div>	
