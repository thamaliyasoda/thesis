...
WHERE
ev.event_status = 1 
AND ev.event_start_datetime >'".date('Y-m-d')."'
...
if(mysqli_num_rows($eventResult ) > 0)
{
 ...
 $date2    = date("Y-m-d",strtotime($events['event_start_datetime']));
		...
		$tablebody .='                    <tr '.$color.'> 
                        ...
                        <td>
							<a href="view_event.php?id='.$events['event_id'].'" class="btn-outline-primary"  >View</a>
                        </td>
                    </tr>';
	}
}	
...
WHERE
practice_status = 1
AND practice_sessions.practice_date >'".date('Y-m-d')."'
ORDER BY
...
if(mysqli_num_rows($practiceResult ) > 0)
{
 ...
 $date2    = date("Y-m-d",strtotime($sessions['practice_date']));
		...
		$practablebody .='                    <tr '.$color.'> 
                        ...
                        <td>
							<a href="view_practice_session.php?session='.$sessions['practice_id'].'" class="btn-outline-primary"  >View Sessions</a>
                        </td>
                    </tr>';
	}
}
...
{
		$practablebody =" No upcoming practice sessions avaiable";
}	
?>
<html>
<head>
			...
			<div class="card">
				<div class="card border-primary">
					<div class="card-body ">
						<div class="row">
							<div class="col-sm-12">
								<h3><b>Upcoming Practice Sessions</b></h3>
							</div>
			...
			<div class="card">
				<div class="card border-primary">
					<div class="card-body ">
						<div class="row">
							<div class="col-sm-12">
								<h3><b>Upcoming Sports Events</b></h3>
							</div>
