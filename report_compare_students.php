...
<title>Sports Desk - KDMV | Report - Compare Two Students </title>
                 ...
                 <ul class="list-unstyled components">
                    ...
                    <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="reportSubmenu">
							...
							<li class="active"><a href="report_compare_students.php"><i class="fas fa-not-equal"></i>Compare Students</a></li>
                        </ul>
                    </li>
					<?php }?>
                </ul>
		...
		<div class="row">
				...
				<div class="card">
					<div class="card border-primary">
						<div class="card-body ">
							<div class="row">
								<div class="col-sm-6">
									<h3><b>First Student</b></h3>
								</div>
							</div>
							<div class="row">
							<div class="col-sm-12">
							<div class="form-group">
								<select name="student_id1" id="student_id1" class="selectpicker form-control "  data-live-search="true">
				...
				<div class="card">
					<div class="card border-primary">
						<div class="card-body ">
							<div class="row">
								<div class="col-sm-6">
									<h3><b>Second Student</b></h3>
								</div>
							</div>
							<div class="row">
							<div class="col-sm-12">
							<div class="form-group">
							<select name="student_id2" id="student_id2" class="selectpicker form-control "  data-live-search="true">
								<option required  value hidden disabled selected>Select a Student</option>
							<?php	
							 $empResult  = $conn->query("SELECT * FROM 
							 students
			...
			<div class="row">
				<div class="col-md-12 d-flex justify-content-center">					
					<button  onclick="redirect();" class="btn btn-primary" ><i class="fas fa-balance-scale"></i>  <span> Compare</span></button>																																				
				</div>
			</div>	
		 ...
		 function redirect()
		 {
			 ...
			 {
				 alert('Both students can not be the same!');
			 }
			 else{
